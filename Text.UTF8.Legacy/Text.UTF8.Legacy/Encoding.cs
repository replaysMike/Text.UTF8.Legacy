...
namespace Text.UTF8.Legacy
{
    ...
    public abstract class Encoding : ICloneable
    {
        ...
        internal EncoderFallback _encoderFallback = null;
        internal DecoderFallback _decoderFallback = null;
        ...
        internal virtual void SetDefaultFallbacks()
        {
            ...
            _encoderFallback = new InternalEncoderBestFitFallback(this);
            _decoderFallback = new InternalDecoderBestFitFallback(this);
        }
        ...
        public static Encoding GetEncoding(int codepage)
        {
            ...
            if (codepage < 0 || codepage > 65535)
            {
                throw new ArgumentOutOfRangeException(
                    nameof(codepage), $"SR.ArgumentOutOfRange_Range: 0, 65535");
            }
            ...
            switch (codepage)
            {
                ...
                case CodePageNoSymbol:                           // 42 CP_SYMBOL
                    throw new ArgumentException($"SR.Argument_CodepageNotSupported {codepage}", nameof(codepage));
            }

            // Is it a valid code page?
            if (EncodingTable.GetCodePageDataItem(codepage) == null)
            {
                throw new NotSupportedException($"SR.NotSupported_NoCodepageData {codepage}");
            }
            ...
            EncoderFallback encoderFallback, DecoderFallback decoderFallback)
        {
            ...
            var fallbackEncoding = (Encoding)baseEncoding.Clone();
        ...
        private void GetDataItem()
        {
            if (_dataItem == null)
            {
                ...
                if (_dataItem == null)
                {
                    throw new NotSupportedException($"SR.NotSupported_NoCodepageData: {_codePage}");
                }
            }
        }
        ...
        public virtual String EncodingName
        {
            get
            {
                string encodingName = GetLocalizedEncodingNameResource(CodePage);
                if (encodingName == null)
                {
                    throw new NotSupportedException(SR.Format(SR.MissingEncodingNameResource, CodePage));
                }
                ...
                if (encodingName.StartsWith("Globalization_cp_", StringComparison.Ordinal))
                {
                    ...
                    // static data table.
                    encodingName = EncodingTable.GetCodePageDataItem(CodePage).EnglishName;
                    if (encodingName == null)
                    {
        ...
        public unsafe string GetString(byte* bytes, int byteCount)
        {
            ...
            return StringUtil.CreateStringFromEncoding(bytes, byteCount, this);
        }
        ...
        public static Encoding UTF8 => UTF8Encoding._default;
        ...
        internal void ThrowBytesOverflow()
        {
            ...
            throw new ArgumentException($"SR.Argument_EncodingConversionOverflowBytes {EncodingName} {EncoderFallback.GetType()}");
        }
        ...
        internal void ThrowCharsOverflow()
        {
            ...
            throw new ArgumentException($"SR.Argument_EncodingConversionOverflowChars {EncodingName} {DecoderFallback.GetType()}");
        }
        ...
        internal class EncodingByteBuffer
        {
                        ...
                        byte* inByteStart, int inByteCount, char* inCharStart, int inCharCount)
            {
                ...
                if (_encoder == null)
                    _fallbackBuffer = _enc.EncoderFallback.CreateFallbackBuffer();
                else
                {
                    _fallbackBuffer = _encoder.FallbackBuffer;
                    ...
                    if (_encoder._throwOnOverflow && _encoder.InternalHasFallbackBuffer &&
                        ...
                        throw new ArgumentException($"SR.Argument_EncoderFallbackNotEmpty {_encoder.Encoding.EncodingName} {_encoder.Fallback.GetType()}");
                }
                _fallbackBuffer.InternalInitialize(_chars, _charEnd, _encoder, _bytes != null);
            }
            ...
            {
                if (_fallbackBuffer._bFallingBack)
                    _fallbackBuffer.MovePrevious();                      // don't use last fallback
                else
                {
            ...
            {
                // Do the fallback
                return _fallbackBuffer.InternalFallback(charFallback, ref _chars);
            }
            ...
            internal unsafe bool MoreData
            {
                get {
                    ...
                    return ((_fallbackBuffer.Remaining > 0) || (_chars < _charEnd));
                }
            }
            ...
            internal unsafe char GetNextChar()
            {
                ...
                char cReturn = _fallbackBuffer.InternalGetNextChar();
